...
def data_to_loader(full_dataset, n_train, n_valid, n_test, batch_size):
    ...
    test_dataset = torch.utils.data.Subset(full_dataset, np.arange(start=n_valid, stop=n_valid+n_test))
