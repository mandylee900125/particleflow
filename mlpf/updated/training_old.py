...
if __name__ == "__main__":
    ...
    #         self.__dict__ = d
    #
    # args = objectview({'train': True, 'n_train': 1, 'n_valid': 1, 'n_test': 2, 'n_epochs': 100, 'patience': 100, 'hidden_dim':32, 'input_encoding': 12, 'encoding_dim': 256,
