...
def train(model, loader, epoch, optimizer, alpha, target_type, device):
    ...
    for i, batch in enumerate(loader):
        ...
        l2 = torch.nn.functional.mse_loss(cand_p4[msk2], target_p4[msk2])  # for regressing p4
...
if __name__ == "__main__":
    ...
    #         self.__dict__ = d
    #
    # args = objectview({'train': True, 'n_train': 1, 'n_valid': 1, 'n_test': 2, 'n_epochs': 20, 'patience': 100, 'hidden_dim':256, 'input_encoding': 12, 'encoding_dim': 125,
    ...
    # 'load': False, 'load_epoch': 3 , 'load_model': 'DataParallel_gen_ntrain_400_nepochs_100_batch_size_4_lr_0.0001_both_alpha_2e-4_noskip_nn3',
    # 'evaluate': True, 'evaluate_on_cpu': False, 'classification_only': False, 'regression_only': True, 'nn1': False, 'conv2': False, 'nn3': True, 'title': ''})
