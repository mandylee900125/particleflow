...
if __name__ == "__main__":
    ...
    #         self.__dict__ = d
    #
    # args = objectview({'train': False, 'n_train': 1, 'n_valid': 1, 'n_test': 2, 'n_epochs': 1, 'patience': 100, 'hidden_dim':256, 'input_encoding': 12, 'encoding_dim': 125,
    ...
    # 'load': True, 'load_epoch': 3 , 'load_model': 'DataParallel_gen_ntrain_400_nepochs_100_batch_size_4_lr_0.0001_both_alpha_2e-4_noskip_nn3',
    # 'evaluate': True, 'evaluate_on_cpu': False, 'classification_only': True, 'nn1': False, 'conv2': False, 'nn3': True, 'title': ''})
