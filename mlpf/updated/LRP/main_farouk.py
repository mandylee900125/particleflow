...
if __name__ == "__main__":
    ...
    if args.explain:
        ...
        # plt.hist(res[:,0].detach().numpy(), bins=np.linspace(0, 0.001, 10), histtype="step", label="type label (cluster/track)")
        # plt.hist(res[:,1].detach().numpy(), bins=np.linspace(0, 0.001, 10), histtype="step", label="pt")
        # plt.hist(res[:,2].detach().numpy(), bins=np.linspace(0, 0.001, 10), histtype="step", label="eta")
        # plt.hist(res[:,5].detach().numpy(), bins=np.linspace(0, 0.001, 10), histtype="step", label="energy")
